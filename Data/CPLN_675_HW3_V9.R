...
cal_fish <- st_read("C:/Users/mktran/Desktop/model/fishnet_clip2", promote_to_multi = FALSE)

# Import Calgary data features
library(readr)
CA_Soil <- st_read("C:/Users/mktran/Desktop/model/tables/CA_Soil.xlsx")
CA_Parks <- st_read("C:/Users/mktran/Desktop/model/tables/CA_Parks.xlsx")
CA_Impervious <- st_read("C:/Users/mktran/Desktop/model/tables/CA_Impervious.xlsx")
CA_Elevation <- st_read("C:/Users/mktran/Desktop/model/tables/CA_Elevation.xlsx")
CA_Waterbodies <- st_read("C:/Users/mktran/Desktop/model/tables/CA_Waterbodies.xlsx")
...
inu_zonal <- st_read("C:/Users/mktran/Desktop/model/tables/ZonalSt_Inundation_v2.xlsx") %>%
  rename(
    cell = OBJECTID_1
  ) %>%
...
dc_fish1 <- st_read("C:/Users/mktran/Desktop/model/dc_geom7", promote_to_multi = FALSE) 
...
# reorder
dcfish_geom <- dcfish_geom[, c("cell", "Low_permeability", "Parks_Majority", "Impervious_majority","elevation_min","Water_majority","geometry")]
...
ggplot() + 
  geom_sf(data=dc_inundation$geometry, aes(fill=factor(ntile(dc_allPredictions,5))), 
          colour=NA) +
  scale_fill_manual(values = c("#edf8fb","#b3cde3","#8c96c6","#8856a7","#810f7c"),
...
ggplot() + 
  geom_sf(data=dc_inundation$dc_allPredictions, aes(fill=factor(ntile(dc_allPredictions,5))), colour=NA) +
  scale_fill_manual(values = c("#edf8fb","#b3cde3","#8c96c6","#8856a7","#810f7c"),
                    labels=as.character(quantile(dc_inundation$dc_allPredictions,
                                                 c(0.1,.2,.4,.6,.8),
                                                 na.rm=T)),
