...
fishnet_ca <- st_read("https://github.com/fdzjavier/CPLN675/blob/main/Data/Fishnet_Clipped/Fishnet_Clip.shp")
```
...
Project it to Calgary  Plane, which has a CRS (coordinate reference system) of 2272.
